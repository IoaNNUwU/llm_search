To the left of the chat window I want to see the side-bar with the ability to select projects and button to download the new one.
...
Uploaded projects should be put in local folder on the server and than evaluated in the background. Evaluation progress should be shown in UI to the right of the project. For evaluation you may create additional table in the database.
